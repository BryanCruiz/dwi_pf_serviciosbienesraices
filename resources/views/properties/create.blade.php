...
<div class="card">
	...
	<div class="card-header">
		<div class="row">
			<div class="col col-md-6"><b>Add Property</b></div>
			<div class="col col-md-6">
				<a href="{{ route('properties.index') }}" class="btn btn-primary btn-sm float-end">Ver lista completa</a>
			</div>
		</div>
	<div class="card-body">
		<form method="post" action="{{ route('properties.store') }}" enctype="multipart/form-data">
			@csrf
            <div class="row mb-4">
				<label class="col-sm-2 col-label-form">Property Image</label>
				<div class="col-sm-10">
					<input type="file" name="property_image" />
				</div>
			</div>
            <div class="row mb-3">
				<label class="col-sm-2 col-label-form">Property name
			...
			<div class="row mb-3">
				<label class="col-sm-2 col-label-form">Description of property
